...
{
    protected $signature = 'pnl:report:daily {--date=} {--upload} {--email=}';
    ...
    protected function sendEmailWithAttachment($filePath, $date, $to)
    {
        try {
            ...
            $subject = "📊 Daily P&L Report - {$formattedDate}";
            
            $message = "Dear Sir,\n\n";
            $message .= "Please find attached the daily P&L report for {$formattedDate}.\n\n";
            ...
            Log::info("Daily P&L report email with attachment sent to: {$to}");
